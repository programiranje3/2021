...
def get_4_digit_substring(a_string):
    ...
    for s in all_4_digit_substrings:
        if s.isdigit():
            return s
    return None
...
def get_m_info(start_url: str, max_pages=1):
    ...
    while True:
        try:
            next_soup = next(crawler)
            h3_list.extend(next_soup.find_all('h3')[:-1])
            poster_list.extend(next_soup.find_all('div', {'class': "lister-item-image ribbonize"}))
...
if __name__ == "__main__":
    ...
    # print(len(h3_all))
    # print()
    # a_div = soup.find('div', {'class': "lister-item-image ribbonize"})
    # print(a_div)
    # divs = soup.find_all('div', {'class': "lister-item-image ribbonize"})
    # print(len(divs))
    # print()
    # print(divs[:3])
    # print()
    ...
    # print(a_div.find_next_sibling())
    # print()
    # print(a_div.find_next_sibling().find('div', {'class': "rating rating-list"}))
    # print()
    #
    ...
    # a_div_soup = BeautifulSoup(str(a_div), features='html.parser')
    # print(a_div_soup)
    # print()
    # print(a_div_soup.find('img'))
    # print()
    #
    ...
    # print(get_specific_page(start_url, page=2))
    # print()
    ...
    # print(get_4_digit_substring('df2345gjgh4568'))
    # print()

    # Test get_m_info()
    for movie_info in get_m_info(start_url, 3):
        print(movie_info)
    print()
